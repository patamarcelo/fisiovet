// components/EmptyAgendaCard.jsx
...
/**
 * Exibe card de lista vazia dentro da agenda de um PET
 * Recebe { pet } — e usa pet.tutor para abrir o modal já preenchido
 */
export function EmptyAgendaPetCard({ pet }) {
        ...
        <View style={styles.wrap}>
            <View style={[styles.card, { borderColor: border, backgroundColor: bg }]}>
                ...
                <Text style={[styles.sub, { color: subtle }]}>
                    Cadastre uma nova sessão ou avaliação para {pet?.nome || 'o pet'}.
                </Text>
